...
android {
    namespace = "com.example.studentattendancemanager"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.studentattendancemanager"
        minSdk = 21
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("androidx.camera:camera-lifecycle:${"1.0.0-alpha07"}")
